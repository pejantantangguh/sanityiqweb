...
const styles = makeStyles((theme) => ({
  cloudBackground: {
    ...
    background: "url('/homepage/bg_starry-night2500W.png')",
      ...
      <div className={classes.column}>
        ...
        <Box component="section" className={classes.contentCopy}>
          <Typography variant="body1">
            With printIQ you get a Management Workflow System (far more than just an MIS) complete
            with functionality specific to your industry segment.
          </Typography>
        </Box>
