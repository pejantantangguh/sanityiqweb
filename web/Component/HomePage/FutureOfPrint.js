		...
		<div className={classes.column}>
			<Box component="section" className={classes.header}>
				<Typography variant="h3">
					Welcome to{" "}
					<span className={classes.greenText}>the future of Print.</span>
				</Typography>
			</Box>
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_digital_green.svg"
					className={classes.imageSegmentation}
					alt="Digital Icon"
				/>
			...
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_flexo_green.svg"
					className={classes.imageSegmentation}
					alt="flexo industry icon"
				/>
				<Typography variant="h3" className={classes.green}>
					Flexo
				</Typography>
			...
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_fulfilment_green.svg"
					className={classes.imageSegmentation}
			...
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_labels_green.svg"
					className={classes.imageSegmentation}
					alt="Labels icon"
				/>
				<Typography variant="h3" className={classes.green}>
			...
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_offset_green.svg"
					className={classes.imageSegmentation}
					alt="offset icon"
				/>
				<Typography variant="h3" className={classes.green}>
			...
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_packaging_green.svg"
					className={classes.imageSegmentation}
					alt="packaging icon"
				/>
				<Typography variant="h3" className={classes.green}>
			...
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_signage_green.svg"
					className={classes.imageSegmentation}
					alt="signage icon"
				/>
				<Typography variant="h3" className={classes.green}>
			...
			<Box component="section" className={classes.segmentCard}>
				<img
					src="/images/svg/icons_wide_format_green.svg"
					className={classes.imageSegmentation}
					alt="wide format icon"
				/>
				<Typography variant="h3" className={classes.green}>
					Wide Format
				</Typography>
