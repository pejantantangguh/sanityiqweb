import { Box, Container, makeStyles, Typography, Grid, Paper } from "@material-ui/core";
  ...
  return (
    <>
      <div className={classes.greenBg}>
        <Container className={classes.centerAlign} maxWidth="sm">
          <Typography variant="h3" component="h1">
            About Us
          </Typography>
          <Typography variant="body1" component="p">
            printIQ is a privately-owned company providing IT, custom software development, and
            business solutions to the printing industry. We have been delivering IT based solutions
            to business for the past 18 years and have staff based in Australia, New Zealand,
            Canada, North America and the UK.
          </Typography>
        </Container>
      </div>
      <Container>
        <Typography variant="h3">Why IQ?</Typography>
        <Typography variant="body1" component="p">
        ...
        <Typography variant="body1" component="p">
          <ul>
            <li>
              We have people that know the various industries and segments in which we work, they
              understand the process, so we’re much more than just an IT company
            </li>
            <li>
              We have our own in-house development team so if we don’t have it, we can build it
            </li>
            <li>
              In our flagship print product, printIQ, we offer the most comprehensive print
              management system on the market today.
            </li>
            <li>
              We’re changing the face of IT, we’re removing the jargon, we’re here to talk and we’ll
              adapt to fit our customers.
            </li>
            <li>
              Our goal is to be the number one choice for MWS; we’ll achieve that one happy customer
              at a time.
            </li>
          </ul>
        </Typography>
